...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var userIdSamples = samplesArray.filter(data => data.id == sample);
    console.log(userIdSamples);
    //  5. Create a variable that holds the first sample in the array.
    var firstSample = userIdSamples[0];
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'The bar chart displays up to 10 of the bacterial species<br>with the most occurrences in the sample',
        showarrow: false
      }]
    };
